    ...
    var pdf = new jsPDF();
        ...
        vm.printPDF = function () {
           ...
           pdf.text(70, 25, 'Missing Persons Intake Form');
            ...
            pdf.text(85, 45, 'Date of Intake to MCM: ' + vm.DateofIntaketoMCMIn);
            ...
            pdf.text(10, 100, 'Time Last Seen:: ' + vm.TimeLastSeenIn);            
            pdf.text(10, 110, 'Location Last Seen/Cross St.: ' + vm.LocationLastSeenCrossStIn);
            pdf.text(10, 120, 'Age: ' + vm.AgeIn); pdf.text(40, 120, 'Gender: ' + vm.GenderIn);
            pdf.text(70, 130, 'Ht: ' + vm.HeightIn); pdf.text(100, 130, 'Wt: ' + vm.WeightIn);
            pdf.text(10, 140, 'Other: ' + vm.OtherIn);
            
            //Distinguishing Characteristics 
            pdf.setFontType('bold');
            pdf.setFontSize(14);            
            pdf.text(10,150, 'Distinguishing Characteristics') //add ' to persons shara
            pdf.setFontType('normal');
            pdf.setFontSize(12);
            pdf.text(10, 160, 'Hair Color: ' + vm.HairColorIn); pdf.text(60, 160, 'Hair Style: ' + vm.HairStyleIn);pdf.text(120, 160, 'Glasses?: ' + vm.GlassesOrContactsIn);
            
            pdf.text(10, 170, 'Eye Color: ' + vm.EyeColorIn);pdf.text(60, 170, 'Eye Features: ' + vm.EyeFeaturesIn);pdf.text(120, 170, 'Eye Brow Features: ' + vm.EyeBrowFeatures);
            
            pdf.text(10, 180, 'Race/Ethniciy: ' + vm.RaceEthnicityIn);
            pdf.text(60, 180, 'Facial Hair: ' + vm.FacialHairIn);
            pdf.text(10, 190, 'Tattos or Piercings: ' + vm.TattoosOrPiercingsIn);
            pdf.text(100, 190, 'Description: ' + vm.commentTattoosIn);
            pdf.text(10, 200, 'Dental Characteristics: ' + vm.DentalCharacteristicsIn);
            pdf.text(10, 200, 'Scars or Birthmarks: ' + vm.ScarsOrBirthmarksIn);
            ...
            pdf.text(10,250, 'LE Phone Number');            
